$(document).ready(function () {
  ...
  $("#originPlace, #destinationPlace").change(validateStepOne);
  $("#originPlace, #destinationPlace").blur(validateStepOne);
  ...
  $("#first_name, #last_name, #email, #phone").keyup(validateSubmit);
});
